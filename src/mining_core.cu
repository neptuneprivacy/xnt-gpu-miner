};
...
// Direct O(n^2) NTT: out[k] = sum_j in[j] * NTT_TABLE[k][j]
__device__ __noinline__ void ntt_16_direct(const uint64_t* __restrict__ in, uint64_t* __restrict__ out) {
    #pragma unroll
    for (int k = 0; k < STATE_SIZE; k++) {
        uint64_t s = 0;
        #pragma unroll
        for (int j = 0; j < STATE_SIZE; j++) {
            s = fast_field_add(s, field_mul_ptx(in[j], NTT_TABLE[k][j]));
        }
        out[k] = s;
    }
}

// Direct O(n^2) INTT: out[j] = sum_k in[k] * INTT_TABLE[j][k]  (n_inv already in table)
__device__ __noinline__ void intt_16_direct(const uint64_t* __restrict__ in, uint64_t* __restrict__ out) {
    #pragma unroll
    for (int j = 0; j < STATE_SIZE; j++) {
        uint64_t s = 0;
        #pragma unroll
        for (int k = 0; k < STATE_SIZE; k++) {
            s = fast_field_add(s, field_mul_ptx(in[k], INTT_TABLE[j][k]));
        }
        out[j] = s;
    }
}

// NTT-based circulant MDS: y = INTT(NTT(x) .* NTT(MDS_first_row))
// __noinline__ keeps tip5_permutation under launch_bounds register limit
__device__ __noinline__ void mds_layer_ntt(const uint64_t* state_in, uint64_t* state_out) {
    uint64_t ntt_x[STATE_SIZE], prod[STATE_SIZE];
    ntt_16_direct(state_in, ntt_x);
    #pragma unroll
    for (int i = 0; i < STATE_SIZE; i++) {
        prod[i] = field_mul_ptx(ntt_x[i], MDS_NTT_MONTY[i]);
    }
    intt_16_direct(prod, state_out);
}

// Explicit circulant MDS: y[i] = sum_j MDS_COEFF[(i-j)&15] * x[j]
// __noinline__ keeps tip5_permutation under launch_bounds register limit
__device__ __noinline__ void mds_layer(const uint64_t* state_in, uint64_t* state_out) {
    uint32_t lo[STATE_SIZE], hi[STATE_SIZE];
    #pragma unroll
    for (int i = 0; i < STATE_SIZE; i++) {
        uint32_t lo32, hi32;
    ...
    #pragma unroll
    for (int i = 0; i < STATE_SIZE; i++) {
        // Circulant: y[i] = sum_j MDS[(i-j)&15] * x[j]
        uint64_t sum_lo = 0, sum_hi = 0;
        #pragma unroll
        for (int j = 0; j < STATE_SIZE; j++) {
            uint32_t c = MDS_COEFF[(i - j) & 15];
            sum_lo += (uint64_t)lo[j] * c;
            sum_hi += (uint64_t)hi[j] * c;
        }
        lo_out[i] = sum_lo;
        hi_out[i] = sum_hi;
    }
...
__device__ __noinline__ void tip5_permutation(uint64_t* state) {
    ...
    for (int round = 0; round < NUM_ROUNDS; ++round) {
        ...
        mds_layer_ntt(temp_state, state);
        for (int i = 0; i < STATE_SIZE; ++i) {
...
void calculate_mining_launch_config(
    ...
    blocks_per_grid = std::max(blocks_per_grid, 1);  // Never launch with 0 blocks
}
...
std::optional<MiningSolution> mine_pow_with_buffer(
    ...
    if (use_phase_split && buffer.d_phase_indices) {
        ...
        while (off < max_nonces) {
            ...
            p1.num_nonces = chunk;
            (void)cudaGetLastError();  // Clear stale error from prior ops (e.g. preprocessing)
